!function (a) {
        ...
        options: {
            ...
            init: function (o) {
                ...
                return a(l).bind("submit", function (e) {
                    ...
                    }), n.trigger("validationLostFocus.validation"), i ? (r.options.preventSubmit && e.preventDefault(), t.addClass("error"), a.isFunction(r.options.submitError) && r.options.submitError(t, e, n.jqValidation("collectErrors", !0))) : (t.removeClass("error"), a.isFunction(r.options.submitSuccess) && r.options.submitSuccess(t, e))
                }), this.each(function () {
                    var t = a(this), o = t.parents(".form-group").first(),
                        l = o.find(".help-block").first(),
                        s = t.parents("form").first(), d = [];
                    ...
                    a.each(d, function (e, n) {
                        var o = t.data("validation" + n + "Message"), l = void 0 !== o,
                            s = !1;
                ...
                return this.each(function () {
                    var t = a(this), i = t.parents(".form-group").first(),
    ...
    a.fn.jqValidation = function (e) {
        return t.methods[e] ? t.methods[e].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof e && e ? (a.error("Method " + e + " does not exist on jQuery.jqValidation"), null) : t.methods.init.apply(this, arguments)
    }, a.jqValidation = function (e) {
        a(":input").not("[type=image],[type=submit]").jqValidation.apply(this, arguments)
    }
}(jQuery);